  ...
  return (
    <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
      <div className="max-w-[1000px] mx-auto px-4 h-16 flex items-center justify-between">
        <Link href="/" className="text-xl font-bold text-red-500 flex items-center gap-2 tracking-tight">
          배달앱
        </Link>
        <nav className="flex items-center gap-4 sm:gap-5">
          {session?.user ? (
            <>
              ...
              <Link href="/checkout" className="relative p-1 text-gray-700 hover:text-red-500 transition-colors flex items-center" title="장바구니">
